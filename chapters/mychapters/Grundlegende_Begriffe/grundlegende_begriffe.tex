...
In seinem Paper „On computable numbers, with an application to the Entscheidungsproblem“ %(Turing, 1937) 
...
Hierbei kam er zur Erkenntnis, dass sich nicht alle mathematischen Probleme durch eine fixe Vorgehensweise lösen lassen. %(Gregory, 1983, p. 647)
...
Dieser Begriff hat sich entwickelt, da manche Tests nicht „public“ sind. %(Chellapilla, et al., 2005, p. 1) (Pavlidis, 2008)
...
Geprägt wurde der Begriff erstmals im Kalten Krieg als Spionagetechnik eingesetzt wurde. %(Joshi & Sardana, February 2011, p. 2) 
...
Nachzulesen sind solche Verfahren in verschiedenen Blogposts, wie %(Perry, 2019).
